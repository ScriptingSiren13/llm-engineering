...
class Review(BaseModel):
    ...
    key_themes:list[str]= Field(description="Write down all the ket themes discussed in the review in a list")
...
print(result)  #full pydantic object
print(result.key_themes)    #one key of pydantic object

result_dict=dict(result)   #result in the form of dict
